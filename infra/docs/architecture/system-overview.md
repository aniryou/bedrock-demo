...
The detailed live request / data plane is [`../architecture.md`](../architecture.md); the build / publish / deploy pipeline is in the [repo README](../../README.md) and [CD setup](../playbooks/cd-setup.md).
