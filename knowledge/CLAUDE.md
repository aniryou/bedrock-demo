...
- **The "how it got here" lives in ADRs** (`docs/adr/`, currently `0001`). Record model-level decisions (privilege/classification, catalog structure) there, keep them current as the model evolves, and consistent with the consuming folders in the mono-repo — not in scattered comments.
