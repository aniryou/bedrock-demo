...
![Order-Triage AgentCore system overview](infra/docs/architecture/system-overview-architecture.svg)

> The whole-system map (start here). One of eight **AWS-style plane diagrams** generated by the
